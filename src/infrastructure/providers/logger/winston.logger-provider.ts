...
} from '@contracts/providers/logger/send-error-logger.provider';
...
} from '@contracts/providers/logger/send-info-logger.provider';
...
export class WinstonLoggerProvider implements ISendErrorLoggerProvider, ISendInfoLoggerProvider, ISendHttpLoggerProvider {
  ...
  public http(parameters: SendInfoLoggerProviderDTO.Parameters): SendInfoLoggerProviderDTO.Result {
